    ...
    return (
      <>
        <form onChange={this.props.handler} onClick={this.SetValidationTrue}>
          ...
          <label>
            <input type="radio" name="children" value="1" />0
          </label>
          <label>
            <input type="radio" name="children" value="2" />1
          </label>
          <label>
            <input type="radio" name="children" value="3" />2
          </label>
          <label>
            <input type="radio" name="children" value="4" />3 +
          </label>
        </form>
    ...
    return (
      <>
        <form onChange={this.props.handler} onClick={this.SetValidationTrue}>
          ...
          <label>
            <input type="radio" name="married" value="2" />
            Не состою в браке
          </label>
        </form>
        <button onClick={this.props.previousPage}>Назад</button>
    ...
    return (
      <>
        <form onChange={this.props.handler} onClick={this.SetValidationTrue}>
          ...
          <label>
            <input type="radio" name="work_time" value="1" />
            Менее 6 месяцев
          </label>
          <label>
            <input type="radio" name="work_time" value="2" />
            от 6 месяцев до 1.5 лет
          </label>
          <label>
            <input type="radio" name="work_time" value="3" />
            от 1.5 до 3 лет
          </label>
          <label>
            <input type="radio" name="work_time" value="4" />
            более 3 лет
          </label>
        </form>
        <button onClick={this.props.previousPage}>Назад</button>
    ...
    return (
      <>
        <form onChange={this.props.handler} onClick={this.SetValidationTrue}>
          ...
          <label>
            <input type="radio" name="work_equals_education" value="1" />
            Да
          </label>
          <label>
            <input type="radio" name="work_equals_education" value="2" />
            Нет
          </label>
        </form>
        <button onClick={this.props.previousPage}>Назад</button>
    ...
    return (
      <>
        <form onChange={this.props.handler} onClick={this.SetValidationTrue}>
          ...
          <label>
            <input type="radio" name="sponsors" value="1" />
            Да
          </label>
          <label>
            <input type="radio" name="sponsors" value="2" />
            Нет
          </label>
        </form>
        <button onClick={this.props.previousPage}>Назад</button>
